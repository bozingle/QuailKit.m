...
handles.interval = 300;%in seconds
...
function handles = updateAudio(handles,c)
    ...
    if (handles.Data.k+c)*handles.Data.boy(2) > handles.Data.SubSamples || handles.Data.k+c <= 0
       ...
       if handles.Data.j == 1
           ...
           handles.Data.k = handles.Data.aoy(2)/handles.Data.boy(2)+1;
...
if handles.Data.k*handles.Data.fs <= handles.Data.SubSamples
    ...
    handles=SetView(handles,false);
    guidata(hObject,handles);
    handles = updateAudio(handles,10);
end
...
if hObject.Value==1
    ...
    map = JRmapMake(handles.Graphics.Map,'AIzaSyDVV89IGxLgZNWt-9fxkTtFMjEfU3fKQTo',results, 200,micDataPaths);
...
Trans(5:6)=handles.Data.TS.Time([handles.Data.b(1),...
    handles.Data.b(2)]);
