...
if initialize
    ...
    for i=1:size(Two_Pop.UserData{2,2},1)
        app.graphics.audioplot(i) = HT_Axis(app.plot_audio,app.state.plot_audio);
        app.graphics.spectrogram(i) = HT_Axis(app.plot_spectrogram,app.state.plot_spectrogram);
        app.graphics.detection(i) = HT_Axis(app.plot_detection,app.state.plot_detection);
    end
    app.graphics.watermark = HT_Axis(app.watermark,app.state.watermark);
else
    for i=1:size(Two_Pop.UserData{2,2},1)
        app.graphics.audioplot(i).clear;
        app.graphics.spectrogram(i).clear;
        app.graphics.detection(i).clear;
    end
